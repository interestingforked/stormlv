...
<div id="layout" <?php echo $class; ?>>
 ...
 <div id="crumbs">
 <ul class="lang">
 <?php if (Yii::app()->language == 'lv'): ?><li class="active">LAT</li><?php else: ?><li><a href="<?php echo $this->link['lv']; ?>">LAT</a></li><?php endif; ?> / 
 <?php if (Yii::app()->language == 'ru'): ?><li class="active">RUS</li><?php else: ?><li><a href="<?php echo $this->link['ru']; ?>">RUS</a></li><?php endif; ?>
 </ul>
   <?php if (Yii::app()->controller->route != 'site/index' AND isset($this->breadcrumbs)): ?>
         <?php
